-- 0003_complete_lesson_rpc.sql — Original complete_lesson RPC
-- Atomic lesson completion: records progress, updates XP/level/streak, checks badges.
-- Replaced by 0004_update_complete_lesson.sql (adds public schema search_path fix).
