-- 0011_fix_complete_lesson_auth.sql
-- Replace caller-supplied p_user_id with auth.uid() inside SECURITY DEFINER function.
-- This prevents any authenticated user from writing XP/streaks/badges for another user.
-- Mirror pattern already used in 0008_review_queue (schedule_review uses auth.uid()).
